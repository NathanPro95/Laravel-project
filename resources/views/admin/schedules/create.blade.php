            ...
            <form method="post" action="{{empty($schedule['id']) ? route('schedule.store') : route('schedule.update',$schedule['id'])}}" role="form">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="scheduleName">Tên công trình</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="construction_plan" value="{{!empty($schedule['construction_plan']) ? $schedule['construction_plan'] : "" }}"  class="form-control" placeholder="Nhập kế hoạch thi công">
                    </div>
                    <div class="form-group">
                        <label for="scheduleStatus">Trạng thái công trình</label>
